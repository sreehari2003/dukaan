...
export const Col = () => {
  return (
    <>
      <div className="w-1/4">
        <div className="bg-[#F2F2F2] p-4 ">Order ID</div>
      </div>
      <div className="w-1/4 ">
        <div className="bg-[#F2F2F2] p-4 flex gap-[2px]">
          Order date <FaSortDown />
        </div>
      </div>
      <div className="w-1/4 ">
        <div className="bg-[#F2F2F2] p-4 ">Order amount</div>
      </div>
      <div className="w-1/4 ">
        <div className="bg-[#F2F2F2] p-4 text-end flex  justify-end text-nowrap">
          Transaction fees
          <svg
